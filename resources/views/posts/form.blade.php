...
@section('body')
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <textarea name="body" class="form-control" id="exampleFormControlTextarea1" rows="3">@isset($post){{ $post->body }}@endisset</textarea>
        </div>
        <div class="mb-3">
            <label for="select1" class="form-label">Categories</label>
        <select name="Categories[]" class="form-select" id="select1" multiple aria-label="multiple select example">
